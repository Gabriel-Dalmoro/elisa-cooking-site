                                ...
                                <div className="bg-white rounded-[2.5rem] shadow-xl border border-stone-100 overflow-hidden">
                                    <div className="p-8 space-y-8">
                                        ...
                                        <div className="text-center space-y-1">
                                            ...
                                            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-stone-400">/ Visite de Chef</p>
                                        </div>

                                        <div className="space-y-4 pt-6 border-t border-stone-50">
                                            {isSubscribed && (
                                                <div className="flex justify-between items-center">
                                                    <span className="text-sm text-emerald-500">Avantage Abonnement (-15%)</span>
                                                    <span className="text-base font-bold text-emerald-500">-{Math.round(calculation.serviceDiscount)}€</span>
                                                </div>
                                            )}
                                            <div className="flex justify-between items-center">
                                                <span className="text-sm text-emerald-500">Économie fiscale (-50%)</span>
                                                <span className="text-base font-bold text-emerald-500">-{Math.round(calculation.taxCredit)}€</span>
                                            </div>
                                            <div className="flex justify-between items-center">
                                                <span className="text-sm text-stone-400">À payer à Elisa</span>
                                                <span className="text-base font-bold text-stone-900">{Math.round(calculation.amountToPayElisa)}€</span>
                                            </div>
                                            <div className="flex justify-between items-center pt-2 border-t border-stone-50">
                                                <span className="text-sm font-bold text-stone-900">Budget Ingrédients</span>
                                                <span className="text-sm text-stone-400">~{Math.round(calculation.groceryRange.min)}€ - {Math.round(calculation.groceryRange.max)}€</span>
                                            </div>
                                        </div>
                                    ...
                                    <div className="bg-white rounded-[3rem] shadow-xl border border-stone-100 overflow-hidden">
                                        <div className="p-10 md:p-12 space-y-10">
                                            ...
                                            <div className="text-center space-y-2">
                                                <p className="text-[11px] font-black uppercase tracking-[0.3em] text-stone-400">Votre coût réel de revient</p>
                                                ...
                                                <p className="text-sm font-black uppercase tracking-[0.3em] text-stone-400 italic">/ Visite de Chef</p>
                                            </div>

                                            <div className="space-y-6 pt-10 border-t border-stone-100">
                                                {isSubscribed && (
                                                    <div className="flex justify-between items-center px-2">
                                                        <span className="text-emerald-500 font-medium text-lg">Avantage Abonnement (-15%)</span>
                                                        <span className="text-xl font-bold text-emerald-500">-{Math.round(calculation.serviceDiscount)}€</span>
                                                    </div>
                                                )}
                                                <div className="flex justify-between items-center px-2">
                                                    <span className="text-emerald-500 font-medium text-lg">Économie fiscale (-50%)</span>
                                                    <span className="text-xl font-bold text-emerald-500">-{Math.round(calculation.taxCredit)}€</span>
                                                </div>
                                                <div className="flex justify-between items-center px-2">
                                                    <span className="text-stone-400 font-medium text-lg">À payer à Elisa</span>
                                                    <span className="text-xl font-bold text-stone-900">{Math.round(calculation.amountToPayElisa)}€</span>
                                                </div>
                                                <div className="flex justify-between items-center pt-6 border-t border-stone-100 px-2">
                                                    <span className="text-lg font-bold text-stone-900">Budget Ingrédients</span>
                                                    <span className="text-lg text-stone-400">~{Math.round(calculation.groceryRange.min)}€ - {Math.round(calculation.groceryRange.max)}€</span>
                                                </div>
                                            </div>
